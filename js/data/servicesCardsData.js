const servicesCardsData = {
    data :[
        ...
        {
            img: './img/icon/artificial-intelligence (1).png',
        title: 'AI ChippestVideos Surveillance',
        ...
        {
            img: './img/icon/idea.png',
            title: 'Social Media Services',
            text: `Capitalize on low hanging fruit to identify a ball park value added activity to beta test.
            Override the digital divide with additional`
        },
        {
            img: './img/icon/intelligence.png',
            title: 'Online Customer Support',
            text: `Capitalize on low hanging fruit to identify a ball park value added activity to beta test.
            Override the digital divide with additional`
        },
        {
            img: './img/icon/machine-learning (1) copy.png',
